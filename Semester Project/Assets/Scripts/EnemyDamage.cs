...
public class EnemyDamage : MonoBehaviour
{
    ...
    public int enemyWorth = 50;  // amount of coins that you get for defeating enemy
    public int damageValue = 10; // amount of damage enemy does when it reaches the end
